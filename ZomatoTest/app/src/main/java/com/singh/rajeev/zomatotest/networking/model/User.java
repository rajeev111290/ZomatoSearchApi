...
public class User implements Parcelable
{
    ...
    protected User(Parcel in) {
        ...
        this.foodieLevel = ((String) in.readValue((String.class.getClassLoader())));
        this.foodieLevelNum = ((Integer) in.readValue((Integer.class.getClassLoader())));
        this.foodieColor = ((String) in.readValue((String.class.getClassLoader())));
        ...
        this.profileDeeplink = ((String) in.readValue((String.class.getClassLoader())));
        this.zomatoHandle = ((String) in.readValue((String.class.getClassLoader())));
    }
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeValue(foodieLevel);
        dest.writeValue(foodieLevelNum);
        dest.writeValue(foodieColor);
        dest.writeValue(profileUrl);
        dest.writeValue(profileImage);
        dest.writeValue(profileDeeplink);
        dest.writeValue(zomatoHandle);
    }
